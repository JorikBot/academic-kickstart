...
<img src = "/img/infographic.png"></img>
...
knitr::kable(
  dev_test[1:5, ], 
  caption = "Median and count are now a column in the original table."
)
```
...
We indeed find back every outlier condition specified in the beginning of this post. Now we don't have to visually inspect our qPCR results in excel anymore! 
