...
The default plots made by the bioanalyzer are, in my opinion, not amazing. For one, the lines are really thin. Furthermore, sometimes to compare different samples, it would be nice to draw two traces is the same plot. Luckily, the bioanalyzer software also lets you export the raw data. This short post will show how to quickly get bioanalyzer trace data into R and ready for plotting. 
