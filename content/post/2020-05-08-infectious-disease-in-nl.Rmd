...
At the start of the 20th century about 3 in 1000 people died of an infection every year. Which disease was reponsible for this?
...
Not the flu, but tuberculoses caused most of these deaths. Surprisingly, the majority of the decrease in amount of deaths by TBC occurred before the discovery of effective antiobitcs against it. This was achieved thru increasing living standards, and isolation of the infected people in sanitoria (horrible, look it up if you want!). Both world wars are clearly trendbreakers. A relapse in living standards immidiatly saw rising cases. 
```{r tb absolute}
death_data %>%
...
The amount of people dying from TBC decreased quickly in the first half of the 20th century. But without a cure TBC remained responsible for over 60% of all deaths from infectious diseases. The antibiotic streptomycin was discovered in 1944, with the first clinical trail running from 1946 to 1948. Finally there was a treatment for TBC. In the following decades more antibiotics were discovered, which further improved outcomes. Nowadays only ~2 people per million die of TBC in the netherlands. 
```{r tb relative}
death_data %>%
