...
Not the flu, but tuberculoses caused most of these deaths. Surprisingly, the majority of the decrease in amount of deaths by TBC occurred before the discovery of effective antibiotics against it. This was achieved thru increasing living standards, and isolation of the infected people in sanitoria (horrible, look it up if you want). Both world wars are clearly trendbreakers. A relapse in living standards immediatly saw rising mortality. 
```{r tb absolute}
death_data %>%
